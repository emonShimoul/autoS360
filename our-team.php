<div class="p-10">
    ...
    <div class="grid grid-cols-3 gap-6 mx-auto">
        <div class="text-center">
            <a href="#"><img class="mb-3 rounded-xl mx-auto h-48 w-48" src="https://i.ibb.co.com/X51vYF3/shimul.jpg"></a>

            <a href="#" class="hover:text-[#D42C2E] text-gray-900 font-semibold text-2xl">john doe</a>
        ...
        <div class="text-center">
            <a href="#"><img class="mb-3 rounded-xl mx-auto h-48 w-48" src="https://i.ibb.co.com/whnKnfg/majhar.jpg"></a>

            <a href="#" class="hover:text-indigo-500 text-gray-900 font-semibold text-2xl">Majharul Islam</a>
        ...
        <div class="text-center">
            ...
            <a href="#" class="hover:text-indigo-500 text-gray-900 font-semibold text-2xl">Emon Shimoul</a>
