<div class="banner bg-cover bg-no-repeat bg-center py-48 px-32 h-screen">
    <div class="w-3/5">
        <h3 class="uppercase text-white text-5xl font-bold font-daysOneRegular">Expert Car Repair Services certified</h3>
...
<div class="banner-below py-12 px-32 flex justify-between gap-4 bg-primaryColor text-white">
    <div class="flex gap-4">
        ...
        <div>
            <h5 class="text-lg uppercase font-bold font-daysOneRegular">Best Prices</h5>
    ...
    <div class="flex gap-4">
        <div class="flex items-center">
            <img class="w-20" src="https://i.ibb.co.com/ypSDLH4/below-banner-2.png" alt="">
        </div>
        <div>
            <h5 class="text-lg uppercase font-bold font-daysOneRegular">100% Guarantee</h5>
    ...
    <div class="flex gap-4">
        <div class="flex items-center">
            <img class="w-20" src="https://i.ibb.co.com/hBPwF5v/below-banner-3.png" alt="">
        </div>
        <div>
            <h5 class="text-lg uppercase font-bold font-daysOneRegular">Certified Mechanics</h5>
